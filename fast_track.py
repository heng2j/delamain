...
#
# # img = cv2.imread('carla_scene.png')[:, :, (2, 1, 0)]
# img = cv2.imread('carla_scene.png')
#
# print(img.shape)
# net, algo = fast_lane_init("culane")
# start_time = timer()
# result = get_lanes(img, net, algo)
# print(timer()-start_time)
# cv2.imshow("debug view", result)
# print(result.shape)
# cv2.waitKey()
# cv2.imshow("debug view", img)
# cv2.waitKey()
# # final = cv2.addWeighted(img, 0.5, result, 0.5, 0)
